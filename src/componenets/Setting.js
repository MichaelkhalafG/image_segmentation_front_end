...
function Setting({ isDarkMode, toggleMode, FontSize, setFontSize }) {
        ...
        <>
            <div className={`col-12  p-lg-4 p-3 ${(isDarkMode) ? "bg-dark " : "bg-light "} mb-2 mt-md-0 mt-5 rounded-3 bg-opacity-50`}>
                ...
                <div className="col-12 my-4">
                    <button type="button" className={`btn ${(isDarkMode) ? "btn-light" : "btn-dark"} col-12`} disabled={!isFormValid}>submit</button>
                </div>
